...
class ResTableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.imageV.image = UIImage(named: restaurants[indexPath.row].image)
        cell.nameL.text = restaurants[indexPath.row].name
        cell.typeL.text = restaurants[indexPath.row].type
        cell.locationL.text = restaurants[indexPath.row].location
